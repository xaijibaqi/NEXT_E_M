...
KalmanFilter::KalmanFilter(int stateSize_ , int measSize_ = 0, int uSize_=0) :stateSize(stateSize_), measSize(measSize_), uSize(uSize_)
{
...
Eigen::VectorXd KalmanFilter::predict(float T)
{
